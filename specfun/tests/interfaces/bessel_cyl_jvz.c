 ...
 */
  ...
  __pyx_t_1 = bessel_cyl_jvz(__pyx_v_v, __pyx_t_double_complex_from_parts(__pyx_v_x, 0));
 ...
 */
    __pyx_t_8 = __pyx_v_i;
    __pyx_t_9 = bessel_cyl_jvz(__pyx_v_v, __pyx_t_double_complex_from_parts((*((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_8 * __pyx_v_x.strides[0]) ))), 0));
    __pyx_t_3 = __pyx_PyComplex_FromComplex(__pyx_t_9); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 29, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
